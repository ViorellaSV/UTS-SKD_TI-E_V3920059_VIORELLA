...
def main():
    ...
    pesanDekripsi= "NCQTIDDINVCKJTYAGNOZPFCEDABFXQLTVTWKMDEHZKCLVLREOWQFRETNPMHYEENOPVHJ"
    kunci = 'VIORELLA'
    mode1 = 'enkripsi'
    mode2 = 'dekripsi' 
...
def main():
    ...
    text = 'NCQTIDDINVCKJTYAGNOZPFCEDABFXQLTVTWKMDEHZKCLVLREOWQFRETNPMHYEENOPVHJ'#Pesan yang akan di enkripsi
    key = [3, 9]
    ...
    print('Ciphertext : WPZOHSSHWUPNKODJBWZGCYPVSJMVAFQOUOXNTSVEGNPQUQIVZXFYIVOWCTEDVVWZCUEK')
